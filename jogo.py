#sei la onde era pra ir esse arquivo meti aqui mesmo
...
assets = {}
assets['boomerang_img']
assets['death_anim']
assets['shoot_sound']
assets['enemy_img']
# ESSES SAO OS ASSETS QUE JA PRECISAMOS ADD
...
class Boomerang(pygame.sprite.Sprite):
    def __init__(self, groups, assets):
        ...
        self.image = assets['boomerang_img']
...
class Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self, assets, left, centery):
        ...
        self.rect.left = left
        self.speedx = 20  # Velocidade fixa para a direita
...
# Classe que representa inimigo morrendo
class Death(pygame.sprite.Sprite):
    ...
    def __init__(self, center, assets):
        ...
        self.death_anim = assets['death_anim']

        # Inicia o processo de animação colocando a primeira imagem na tela.
        self.frame = 0  # Armazena o índice atual na animação
        self.image = self.death_anim[self.frame]  # Pega a primeira imagem
        self.rect = self.image.get_rect()
