...
def load_assets():
    ...
    assets['player'] = pygame.image.load(path.join(IMG,'aviao2.png')).convert_alpha()
    assets['player'] = pygame.transform.scale(assets['player'], (32, 18))
    assets['bullet'] = pygame.image.load(path.join(IMG,'bullet.png')).convert_alpha()
    assets['bullet'] = pygame.transform.scale(assets['bullet'], (40, 9))
    assets[IMG_ENEMY_TEST] = pygame.image.load(path.join(IMG,'img_enemyTest.png')).convert_alpha()
